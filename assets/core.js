...
const CRUMB = {
  ...
  'golf-fitting':'golf', 'golf-business':'golf',
...
const PAGE_URL = {
  ...
  'golf-fitting':'golf-fitting.html', 'golf-business':'golf-business.html',
...
T.ko.nav = { home:`Home`, bizhub:`BizHub`, about:`BizHub 소개`, location:`오시는 길`, news:`소식`,
  ...
  golf:`3F 골프피팅`, 'golf-fitting':`피팅 서비스`, 'golf-business':`비즈니스 골프`,
...
T.en.nav = { home:`Home`, bizhub:`BizHub`, about:`About BizHub`, location:`Location`, news:`News`,
  ...
  golf:`3F Golf Fitting`, 'golf-fitting':`Fitting Service`, 'golf-business':`Business Golf`,
...
function siteHeader(current, lang){
  const t = T[lang];
  const topKeyOf = k => { if(['home','membership','contact'].includes(k)) return k; for(const n of NAV){ if(n.children && n.children.some(c=>c.key===k)) return n.key; } return k; };
